...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~rBN1GapZ#HfsHGKeN6zk6ZZ0l-XEqX37U-QNGCYW3yUL6ydZ6HYY",  // Your bot's session ID (keep it secure)
    PREFIX: getConfig("PREFIX") || ".",  // Command prefix (e.g., "., / ! * - +")
    BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "𝗠𝗿᭄𝙺eutly🌀』-MD",  // Bot's display name
    MODE: process.env.MODE || "public",        // Bot mode: public/private/group/inbox
    // ===== OWNER & DEVELOPER SETTINGS =====
    OWNER_NUMBER: process.env.OWNER_NUMBER || "2250788145722",  // Owner's WhatsApp number
    
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "",           // Owner's name
    
    DEV: process.env.DEV || "2250788145722",                     // Developer's contact number
    ...
    STICKER_NAME: process.env.STICKER_NAME || "𝗠𝗿᭄𝙺eutly🌀』-MD",     // Sticker pack name
...
// make anti link true,false for groups 
    ...
    // Block const { getConfig } = require("./lib/configdb");
const fs = require('fs');
const path = require('path');
...
view-once messages?
    ...
    PUBLIC_MODE: prconst { getConfig } = require("./lib/configdb");
const fs = require('fs');
const path = require('path');
...
ocess.env.PUBLIC_MODE || "true",     
    // Allow public commands?
    ALWAYS_ONLINconst { getConfig } = require("./lib/configdb");
const fs = require('fs');
const path = require('path');
...
E: process.env.ALWAYS_ONLINE || "false",
    // Show bot as always online?
    AUTO_STATUS_REACT: process.env.AUTO_STATUS_REACT || "false",
    // React to status updates?
    AUTO_STATUS_SEEN: process.env.AUTO_STATUS_SEEN || "true",
